...
export default function Pill({ children, onClick, fontSize='sm', variant='secondary', className='',}: { children: string | ReactNode, onClick?: MouseEventHandler | undefined, fontSize?: 'xs' | 'sm'| 'lg'| 'xl'| '2xl'| '3xl'| '4xl'| '5xl'| '6xl'| '7xl'| '8xl'| '9xl', variant?: 'primary' | 'secondary' | 'display', className?: string }) {
    let variantStyle = '' 
